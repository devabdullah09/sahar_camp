    ...
    <footer className="bg-charcoal text-white">
      <div className="container mx-auto px-4 sm:px-6 lg:px-8 py-6 sm:py-8">
        <div className="max-w-6xl mx-auto">
          {/* Main Footer Content */}
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 sm:gap-12 pb-4 sm:pb-6 border-b border-gray-700">
            {/* Left: Navigation Links */}
            <div className="text-left">
              <h3 className="text-sm font-semibold text-white mb-3 uppercase tracking-wide">Navigation</h3>
            ...
            <div className="text-left md:text-center">
              ...
              <a 
                ...
                className="inline-flex items-center space-x-2 text-gray-200 hover:text-white transition-colors"
              >
          ...
          {/* Copyright */}
          <div className="pt-4 sm:pt-5 text-center text-gray-400 text-xs">
